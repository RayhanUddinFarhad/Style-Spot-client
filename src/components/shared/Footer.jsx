...
const Footer = () => {
  return (
    <div>
      <footer className="footer p-10 bg-[#EEEFFB] text-base-content">
...
<p>17 Princess Road, London, Greater London NW1 8JR, UK</p>
      ...
      <footer className="footer px-10 py-4 border-t bg-[#EEEFFB] text-base-content border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p> StyleSpot <br />Providing reliable tech since 2023</p>
        </div>
